...
export const clear = async () => {
  ...
  await AsyncStorage.removeItem('NOTFICTION_TOKEN');
  await AsyncStorage.removeItem('GET_USER_VOUCHERS');
  await AsyncStorage.removeItem('NEW_PHONE_DATA');
...
export const getDateHandler = (date?: string, time?: boolean) => {
  ...
  return `${day.getFullYear()}-${day.getMonth() + 1}-${day.getDate()}${time ? hours : ''
    }`;
};
/**
